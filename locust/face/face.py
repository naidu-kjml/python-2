...
class UserBehavior(TaskSet):
	...
	def face_regist(self):
		...
		files = {'picture':('face1.jpg',open(r'C:\Users\xjming9\Desktop\face1.JPG','rb'),'image/jpeg', {}),'idcardFront':('face1.jpg',open(r'C:\Users\xjming9\Desktop\face1.JPG','rb'),'image/jpeg', {}),'idcardBack':('face2.jpg',open(r'C:\Users\xjming9\Desktop\face1.JPG','rb'),'image/jpeg', {})}
		payload = {
			'userId':data['userId'],
			'userName':'林七',
			'ver':'01',
